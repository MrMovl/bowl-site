defmodule BowlSiteWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("bowl_site.repo.query.total_time", unit: {:native, :millisecond}),
      summary("bowl_site.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("bowl_site.repo.query.query_time", unit: {:native, :millisecond}),
      summary("bowl_site.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("bowl_site.repo.query.idle_time", unit: {:native, :millisecond}),
  ...
  defp periodic_measurements do
    [
      {BowlSiteWeb.Telemetry, :dispatch_node_stats, []}
    ]
  end

  def dispatch_node_stats do
    :telemetry.execute([:bowl_site, :node], %{}, %{node: node()})
  end
end
